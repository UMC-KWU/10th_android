...
class WishlistFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            dataStoreModule.getName(requireContext()).collect { productList ->
                val wishAdapter = WishlistAdapter(productList.toMutableList()) {
                }
                binding.WishlistRecyclerview.adapter = wishAdapter
            }
        }
    }
