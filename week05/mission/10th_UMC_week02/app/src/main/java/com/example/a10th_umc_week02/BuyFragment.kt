...
class BuyFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val buyDataList = mutableListOf(
            BuyData("Air Jordan XXXVI", "US$185", R.drawable.ic_blackshoes),
            BuyData("Nike Air Force 1 '07", "US$115", R.drawable.ic_whiteshoes))

        val adapter = BuyAdapter(buyDataList){
        }

        binding.BuyRecyclerview.adapter = adapter
        binding.BuyRecyclerview.layoutManager = GridLayoutManager(requireContext(),2, GridLayoutManager.VERTICAL, false)
    }
